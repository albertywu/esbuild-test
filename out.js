(() => {
  ...
  const Head = ({title: title2}) => {
    return /* @__PURE__ */ react.default.createElement("head", null, /* @__PURE__ */ react.default.createElement("title", null, title2));
  };

  // components/report-body.jsx
  const react3 = __toModule(require_react());

  // components/footer.jsx
  const react2 = __toModule(require_react());
  const Footer = ({year: year2}) => {
    return /* @__PURE__ */ react2.default.createElement("footer", null, "year: ", year2);
  };

  // components/report-body.jsx
  const ReportBody = ({summary: summary2, year: year2}) => {
    return /* @__PURE__ */ react3.default.createElement("body", null, "summary: ", summary2, /* @__PURE__ */ react3.default.createElement(Footer, {
      year: year2
    }));
  };

  // components/report.jsx
  const Report = ({title: title2, summary: summary2, year: year2}) => {
    return /* @__PURE__ */ react4.default.createElement("html", null, /* @__PURE__ */ react4.default.createElement(Head, {
      title: title2
    }), /* @__PURE__ */ react4.default.createElement(ReportBody, {
      summary: summary2,
      year: year2
    }));
  };
  ...
  const year = 2020;
  console.log(Server.renderToString(/* @__PURE__ */ React5.createElement(Report, {
    title,
    summary,
    year
  })));
